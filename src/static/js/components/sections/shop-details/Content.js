								...
								<div className="shop-detail-image">
									<div className="detail-slider">
											...
											{item.image.map((image, i) => (
												<SwiperSlide key={i}>
													...
													<div className="shop-type-tag">
														{item.sale === true ? (
															<div className="product-label new type-tag">
																<span>Sale</span>
															</div>
														) : (
															""
														...
														{item.discount > 0 || item.discount !== "" ? (
															<div className="product-label discount type-tag">
										...
										<Swiper
											...
											{...settingsThumb}
											onSwiper={this.state.thumbsSwiper}>
											{item.image.map((image, i) => (
												<SwiperSlide key={i}>
													<img
														src={process.env.PUBLIC_URL + "/" + image}
								...
								<div className="shop-detail-contents mb-md-40 mt-md-40">
									...
									<div className="quantity mb-xl-20">
										...
										<div className="product-qty-input">
											...
											<input
												type="text"
												className="form-control form-control-qty text-center"
												name="name"
									...
									<div className="shop-bottom">
										<div className="shop-meta mt-20">
											<p className="text-custom-black mb-0 fw-600">
												Categories:
											</p>
																				...
																				<div className="comment-content">
																					<div className="comment-meta">
																						<div className="comment-meta-header">
																							<h6 className="text-color-secondary fw-500 author mb-3">
																								{author.name}
																							</h6>
																							<div className="post-date">
																								<div className="date bg-custom-black">
																									{review.commentdate}
																								</div>
																							</div>
																						</div>
																						<div className="comment-meta-reply">
																							...
																							<Link
																								to="#"
																								className="comment-reply-link btn-first red-btn text-custom-black">
																								Reply
																							</Link>
																						</div>
																					</div>
							...
							{shopbox
								.filter((product) => {
									return (
										...
										product.category.some((r) => item.category.includes(r))
									);
								})
								.slice(0, 4)
								.map((product, i) => (
										...
										<div className="product-box mb-md-20">
											<div className="product-img">
												...
												<div className="button-group">
													...
													<OverlayTrigger
														placement="left"
														overlay={quickviewtip}>
														<Link
															to="#"
															onClick={(e) => this.modalShow(product.id)}>
															{" "}
												...
												<div className="product-status">
													<ul className="product-raised">
														<li>
															...
															{new Intl.NumberFormat().format(product.sold)}
														</li>
														<li>
															<strong>Goal:</strong>
															<span className="text-highlight">
																{" "}
																{new Intl.NumberFormat().format(product.goal)}
															</span>
														</li>
													</ul>
