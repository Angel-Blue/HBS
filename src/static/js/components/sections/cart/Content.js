						...
						<div className="col-md-12">
							<div className="tracking-sec">
								<div className="tracking-details padding-20 p-relative">
									...
									<h6 className="text-light-black fw-500 no-margin">
										9:00pm-9:10pm
									</h6>
												...
												<div className="checkout-product" key={i}>
													<div className="img-name-value">
														...
														<div className="product-value">
															{" "}
															<span className="text-light-white">{qty}</span>
														</div>
								...
								<div className="row">
									...
									<div className="col-lg-5">
										<div className="price-table u-line">
											...
											<div className="item">
												{" "}
												<span className="text-light-white">Delivery fee:</span>
												<span className="text-light-white">$15.00</span>
											</div>
											<div className="item">
												{" "}
												<span className="text-light-white">Tax and fees:</span>
												<span className="text-light-white">$10.00</span>
											</div>
											<div className="item">
												{" "}
												<span className="text-light-white">Driver tip:</span>
												<span className="text-light-white">$1.00</span>
											</div>
										</div>
										<div className="total-price padding-tb-10">
											<h5 className="title text-light-black fw-500">
												Total:{" "}
												<span>
													$
													{new Intl.NumberFormat().format(
