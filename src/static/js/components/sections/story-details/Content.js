										...
										<div className="col-lg-6 col-md-6">
											<div className="profile-img full-height">
												<img
													...
													alt={item.name}
													className="img-fluid full-width full-height"
												/>
											</div>
										</div>
										<div className="col-lg-6 col-md-6">
											<div className="profile-content">
												...
												<div className="cause-progress profile-donate">
													<div
														...
														style={{
															width: (item.raised * 100) / item.goal + "%",
														}}>
														<span>
															{new Intl.NumberFormat().format(
																((item.raised * 100) / item.goal).toFixed(2)
															)}
															%
														</span>
													</div>
												...
												<div className="causes-amount">
													<div className="left">
														...
														<span>
															{new Intl.NumberFormat().format(item.raised)}
														</span>
													</div>
													<div className="right">
														<p className="text-dark">History</p>
														<span>
															{new Intl.NumberFormat().format(item.goal)}
														</span>
													</div>
												</div>
												<div className="bottom-group">
													<Link to="#" className="btn-solid with-line">
														<span>
															Donate Now <i className="fas fa-caret-right" />
														</span>
													</Link>
														...
														<ul className="custom">
															{getSocialShare(item.title).map((social, i) => (
																<li key={i}>
																	<Link
																		to="#"
																		className={social.iconstyle}
																		onClick={(e) =>
																			this.openSocialPopup(social, i)
																		}>
									...
									<div className="col-12">
											...
											<div className="row">
												{item.gallery.map((image, i) => (
													<div className="col-md-3" key={i}>
														<a
															href={process.env.PUBLIC_URL + "/" + image}
															className="popup-image">
															<img
																src={process.env.PUBLIC_URL + "/" + image}
																alt="img"
																className="img-fluid rounded mx-auto d-block full-width"
															/>
														</a>
													</div>
												))}
											...
											<div className="row">
												<div className="col-lg-8 col-md-6">
													<div className="tags-box">
														<span className="fs-18 text-light-white">
															<i className="fas fa-tags" />
														</span>
														<div className="tags">
															{getTags(item.tags).map((tag, i) => (
																<Link to={"/story/tag/" + tag.id} key={i}>
																	{tag.title}
																</Link>
															))}
														</div>
										...
										<div className="comment-box">
											<div className="section-header-left">
												<h6 className="text-light-black header-title">
															...
															<div className="review-user" key={i}>
																<div className="review-user-img">
																	...
																	<div className="reviewer-name">
																		<p className="text-light-black fw-600">
																			{author.name}
																		</p>
																	</div>
																</div>
												...
												<div className="row">
													<div className="col-md-6">
														<div className="form-group">
															<label className="text-light-black fw-600">
																Full Name
															</label>
															<input
																type="text"
