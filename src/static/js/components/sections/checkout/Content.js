...
class Content extends Component {
	constructor(props) {
		super(props);
		this.state = {
			priceTotal: checkoutItems.reduce(
								...
								<div className="row mb-xl-20">
									<div className="col-md-6">
										<div className="section-header-left">
											<h3 className="text-light-black header-title fw-700">
												Review and place order
											</h3>
										</div>
										<h6 className="text-light-black fs-14">
											Review address, payments, and tip to complete your
											purchase
										</h6>
										<h6 className="text-light-black mb-2">
											Your order setting
										</h6>
										<p className="text-light-green fw-600">
											Delivery, ASAP (60-70m)
										</p>
										...
										<p className="text-light-white mb-1">
											314 79th st 70 Brooklyn, NY 11209
											<br />
											Cross Street, Rite Aid
										</p>
										...
										<div className="advertisement-img">
											<img
												src={
													...
													"/assets/img/shop/product1.jpg"
												}
												className="img-fluid full-width image-fit"
										...
										<div className="payment-sec">
											...
											<div className="form-group">
												<label className="custom-checkbox">
													...
													<span className="checkmark" /> Spare me the napkins
													and plasticware. I'm trying to save the earth.
												</label>
											</div>
											<div className="section-header-left">
												<h3 className="text-light-black header-title">
															...
															<div className="card">
																<div className="card-header">
																	<Accordion.Toggle
																		...
																		variant="link"
																		eventKey="0"
																		className="p-0 card-link fw-500 fs-14">
																		...
																		<div className="form-group">
																			<div className="credit-card gift-card p-relative">
																				<input
																					type="text"
																					name="#"
																					className="form-control-submit fs-16"
																					defaultValue="AC2B76"
																				/>
																			</div>
																		</div>
																	...
																	<div className="card-body no-padding payment-option-tab">
																		<div className="form-group">
																			<div className="credit-card promocode p-relative input-group">
																				...
																				<button
																					type="submit"
																					className="btn-second btn-submit ml-1">
																					Apply
																				</button>
																			</div>
																		</div>
																...
																<Tab.Content>
																	<Tab.Pane eventKey="tab-1">
																		<div className="form-group">
																			<div className="credit-card p-relative">
																				<input
																					...
																					name="#"
																					className="form-control form-control-submit"
																					defaultValue="VISA....1877,exp 12/21"
																				/>
																			</div>
																		</div>
																		<div className="section-header-left">
																								...
																								<div className="custom-tip">
																									<div className="input-group mb-3">
																										<div className="input-group-prepend">
																											{" "}
																											<span className="input-group-text text-light-green fw-500">
																												Custom tip
																											</span>
																										</div>
																										<input
																		...
																		<div className="form-group">
																			<label className="custom-checkbox">
																				...
																				Donate $0.77 to No kid Hungry. By
																				checking this box you agree to the
																				Donate the Change{" "}
																		...
																		<p className="text-center text-light-black no-margin">
																	...
																	<Tab.Pane eventKey="tab-2">
																		<div className="row">
																			<div className="col-md-4">
																				<div className="form-group">
																					<label className="text-light-white fw-700">
																						Card Number
																					</label>
																	...
																	<Tab.Pane eventKey="tab-3">
																		<p className="text-light-black">
																			Have the cash ready when you receive your
																			order.
																		</p>
																		<div className="section-header-left">
																			<h3 className="text-light-black header-title">
																		...
																		<div className="form-group">
																			<label className="custom-checkbox">
																				<input type="checkbox" name="#" />{" "}
																				<span className="checkmark" />
																				Apologies, but you can't donate with the
																	...
																	<Tab.Pane eventKey="tab-4">
																		<p className="text-light-black">
																			Please review your order and make any
																			necessary changes before checking out with
																			PayPal.
																		</p>
																		<div className="section-header-left">
																			<h3 className="text-light-black header-title">
																		...
																		<div className="form-group">
																			<button
																				type="submit"
																				className="btn-first paypal-btn text-custom-white full-width fw-500">
																				Checkout with
																				<img
																					src={
																						process.env.PUBLIC_URL +
																						"/assets/img/pay-pal.png"
																					}
																					alt=""
																				/>
																			</button>
																	...
																	<Tab.Pane eventKey="tab-5">
																		...
																		<p className="text-center text-light-black no-margin">
																			By placing your order, you agree to Nina's{" "}
																			<Link to="#">terms of use</Link> and{" "}
																			<Link to="#">privacy agreement</Link>
																		</p>
																	</Tab.Pane>
								...
								<div className="cart-detail-box">
									<div className="card">
										<div className="card-header padding-15 fw-700">
											Your order from
											<p className="text-light-white no-margin fw-500">
												Jhon Deo
											</p>
										</div>
										<div className="card-body no-padding" id="scrollstyle-4">
														...
														<div className="cat-name">
															<Link to={"/shop-details/" + item.id}>
																<p className="text-light-green fw-700">
																	<span className="text-dark-white">{qty}</span>
																	{item.title}
																</p>
											...
											<div className="item-total">
												<div className="total-price border-0 pb-0">
													{" "}
													<span className="text-dark-white fw-600">
														Items subtotal:
													</span>
													<span className="text-dark-white fw-600">
														$
												...
												<div className="total-price border-0 pt-0 pb-0">
													{" "}
													<span className="text-light-green fw-600">
														Delivery fee:
													</span>
													<span className="text-light-green fw-600">
														$15.00
												...
												<div className="total-price border-0 ">
													{" "}
													<span className="text-light-black fw-700">
														Total:
													</span>
													<span className="text-light-black fw-700">
														$
														{new Intl.NumberFormat().format(
															(this.state.priceTotal + 26).toFixed(2)
														)}
													</span>
												</div>
											</div>
										...
										<div className="card-footer p-0 modify-order">
											<Link
												to="/cart"
												className="full-width fw-500 bg-light-green d-block text-center text-white">
												<i className="fas fa-chevron-left mr-2" /> Modify Your
												Order
											</Link>
											<Link to="/checkout" className="total-amount">
												{" "}
												<span className="text-custom-white fw-700">TOTAL</span>
												<span className="text-custom-white fw-700">
													$
													{new Intl.NumberFormat().format(
														(this.state.priceTotal + 26).toFixed(2)
													)}
