							...
							<div className="large-product-box  p-relative">
								<div className="featured-product-box box-shadow">
									<div className="featured-pro-title">
										<h4 className="fs-22">
											<strong className="text-color-secondary"> Deal </strong>of
											The Week
										</h4>
									</div>
									<div className="featured-pro-content">
										<div className="featured-pro-text">
											<h5>
												<Link to="#">Artistic Souvenir Takeaway</Link>
											</h5>
											<p>
												Lorem ipsum dolor sit amet, ctetur adipiscing elit, sed
												do eiusmod
											</p>
									...
									<div className="featured-pro-bottom">
										<ul>
											<li>
												Distribute: <strong>150000 </strong>
											</li>
											<li>
												Goal: <strong>200000</strong>{" "}
											</li>
										</ul>
									</div>
								</div>
											...
											<div className="product-img">
												...
												<div className="button-group">
													...
													<OverlayTrigger
														...
														<Link
															to="#"
															onClick={(e) => this.modalShow(item.id)}>
															{" "}
												...
												<div className="product-status">
													<ul className="product-raised">
														<li>
															...
															{new Intl.NumberFormat().format(item.sold)}
														</li>
														<li>
															<strong>Goal:</strong>
