								...
								<div className="swiper-container">
									<div className="swiper-wrapper">
										<div className="swiper-slide">
											<Link
												to={"/shop-details/" + modalContent.id}
												className="popup">
												<img
													src={
														process.env.PUBLIC_URL + "/" + modalContent.image[0]
													}
						...
						<div className="shop-detail-contents mb-md-40 mt-md-40">
							...
							<div className="price">
								<h4 className="text-custom-red price-tag">
									<span className="text-custom-red price-tag mr-2">
										$
										{new Intl.NumberFormat().format(
											(
												(modalContent.price * (100 - modalContent.discount)) /
												100
											).toFixed(2)
										)}
									</span>
									{modalContent.discount > 0 || modalContent.discount !== "" ? (
										<span className="text-light-white fw-400 fs-14">
											$
											{new Intl.NumberFormat().format(
							...
							<div className="availibity mt-20">
								<h6 className="text-custom-black fw-600">
									Avability:
							...
							<div className="shop-bottom">
								<div className="shop-meta mt-20">
									...
									<ul className="list-inline ml-2">
										{getCategories(modalContent.category)
											.slice(0, 3)
											.map((cat, i) => (
								...
								<div className="product-btn mt-20">
									{modalContent.stock === true ? (
										<button type="button" className="btn-solid with-line ml-2">
											Add To Cart <i className="pe-7s-cart" />
										</button>
									) : (
										<button
											type="button"
